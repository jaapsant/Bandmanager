              ...
              <div className="flex items-center text-gray-700">
                {gig.isMultiDay ? (
                  ...
                  <>
                    ...
                    <span className="text-xs sm:text-sm">{new Date(gig.date).toLocaleDateString(undefined, { month: 'short', day: 'numeric' })}</span>
                  </>
                )}
              </div>
            ...
            <td className="px-3 md:px-6 py-3 md:py-4">
              ...
              <div className="sm:hidden">
                <div className="flex items-center gap-2">
                  ...
                  {!showHistory && (
                    hasUserAvailability ? (
                      <AvailabilityStatus status={gig.memberAvailability[user.uid].status} size="sm" />
                    ) : (
